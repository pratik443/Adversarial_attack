...
class sketch_Dataset(data.Dataset):
    def __init__(self, hp, mode):
        ...
        self.hp = hp
        self.mode = mode
        coordinate_path = os.path.join('/content/gdrive/MyDrive/Univ of Surrey Work/sketch_adversarial-master/Dataset/TU_Berlin')
    ...
    def __getitem__(self, item):
        ...
        if self.mode == 'Train':
            ...
            sample = {'sketch_img': sketch_img, 'sketch_path': self.Train_Sketch[item], 'sketch_label': self.name2num[sketch_path.split('/')[0]]}
            ...
            sample = {'sketch_img': sketch_img, 'sketch_path': sketch_path, 'sketch_label': self.name2num[sketch_path.split('/')[0]]}
